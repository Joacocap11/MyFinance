...
export default function Dashboard() {
  ...
  return <ScrollView style={commonStyles.page} contentContainerStyle={styles.content} refreshControl={<RefreshControl refreshing={report.isRefetching || accounts.isRefetching} onRefresh={refresh} tintColor={colors.primary} /> }>
    ...
    <Link href="/movement/new" asChild><Pressable accessibilityRole="button" accessibilityLabel="Nuevo movimiento" style={({ pressed }) => [styles.fab, pressed && styles.pressed]}><Icon name="add" size={24} color={colors.surface} /><Text style={styles.fabText}>Nuevo movimiento</Text></Pressable></Link>
