...
export default function TabsLayout() {
  ...
  return <Tabs screenOptions={{ headerShown: true, tabBarActiveTintColor: colors.primary, tabBarInactiveTintColor: colors.muted, tabBarLabelStyle: { fontSize: 12, fontWeight: "700" }, tabBarStyle: { borderTopColor: colors.border, height: baseHeight + insets.bottom, paddingBottom: basePaddingBottom + insets.bottom, paddingTop: 6 } }}>
